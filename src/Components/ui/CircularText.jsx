...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`mx-auto rounded-full h-[100px] w-[100px] md:w-[180px] md:h-[180px] text-white font-semibold text-center cursor-pointer origin-center ${className}`}
      animate={controls}
    ...
    >
      {letters.map((letter, i) => {
        ...
        return (
          <span
            key={i}
            className="absolute inline-block inset-0 text-sm md:text-lg transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]"
